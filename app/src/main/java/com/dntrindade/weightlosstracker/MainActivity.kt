...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainItems.add(
            MainItem(
                id = 3,
                drawableId = R.drawable.ic_alimentacao,
                textStringId = R.string.label_alimentacao,
                color = Color.WHITE
            )
        )
        mainItems.add(
            MainItem(
                id = 4,
                drawableId = R.drawable.ic_correr,
                textStringId = R.string.label_correr,
                color = Color.WHITE
            )
        )
        ...
        val adapter = MainAdapter(mainItems) { id ->
            when (id) {
                ...
                4 -> {
                    val intent = Intent(this@MainActivity, CorrerActivity::class.java)
                    startActivity(intent)
                }
            }
